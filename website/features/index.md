...
| **Packages** | bat, eza, btop, and the Claude Code status line | [Packages](packages.md) |
...
A shared thread across the visual tools (alacritty, bat, eza, btop, oh-my-posh, neovim) is the
